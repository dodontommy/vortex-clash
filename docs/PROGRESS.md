...
## Next Up
- [ ] Implement facing direction auto-correction (characters face each other)
- [ ] Implement dash_forward and dash_backward
...
- [2026-02-21] Phase 3 in progress: player state machine, two-player support
